    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-6 col-sm-4 col-md-4 col-xs-12" style="s font-weight:500;">
                  ...
                  <div class="col-md-4"><a href="shoesmgmt.php" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Shoes mgmt</a></div>
                    ...
                    <!-- /.col-lg-12 -->
                     ...
                     <div class="row">
             <center><h3 style="font-size:20px;font-weight:bold">Add Shoes</h3></center>
                    <div class="col-md-3"></div>
                    <form action="../../codes/scode.php" method="post" enctype="multipart/form-data">
                    <div class="col-md-6" style="border:2px solid #47484b;border-radius:5px;margin-top:10px;">
                       <h4 style="font-weight:400"> Shoes Name:-</h4>
                        <input type="text" name="sname" class="form-control" required="required" style=" color:black;" placeholder="Shoes Name"/><br>
                        <h4 style="font-weight:400"> Shoes Picture:-</h4>
                        <input type="file" class="form-control" required="required" name="spic" /><br>
                        <h4 style="font-weight:400"> Shoes Type:-</h4>
                        <select class="form-control" name="scat">
                        <option disabled selected>Select Shoes</option>
                        <option> Black Denim Shoes</option>
                        <option>Black Shoes</option>
                        <option>Red Shoes</option>
                        <option>Full formal Shoes</option>
                        <option>Full Denim Shoes</option>
                            </select>
                        <br><br>
