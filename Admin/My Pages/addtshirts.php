    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
             <center><h3 style="font-size:20px;font-weight:bold">Add T-Shirts</h3></center>
                    <div class="col-md-3"></div>
                    <form action="../../codes/tcode.php" method="post" enctype="multipart/form-data">
                    <div class="col-md-6" style="border:2px solid #47484b;border-radius:5px;margin-top:10px;">
                       <h4 style="font-weight:400"> T-Shirt's Name:-</h4>
                        <input type="text" name="tname"class="form-control" required="required" style=" color:black;" placeholder="T-Shirts Name"/><br>
						<h4 style="font-weight:400"> T-Shirt's Picture:-</h4>
                        <input type="file" class="form-control" required="required" name="tpic" /><br>
                        <h4 style="font-weight:400"> T-Shirt's Type:-</h4>
                        <select class="form-control" name="ttype">
                        <option disabled selected>Select T-Shirt's</option>
                        <option>Denim T-Shirts</option>
                        <option>Black Printed T-Shirts</option>
                        <option>Red Printed T-Shirts</option>
                        <option>Full T-Shirts</option>
                        <option>Full Denim T-Shirts</option>
                            </select>
                        <br><br>
