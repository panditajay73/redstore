        ...
        <div id="page-wrapper">
            <div class="container-fluid">
             ...
             <div class="col-lg-6 col-sm-4 col-md-4 col-xs-12" style="font-weight:500;">
                ...
                <div class="row">
             <center><h3 style="font-size:20px;font-weight:bold">Change Password</h3></center>
                    ...
                    <div class="col-md-6" style="border:2px solid #47484b;border-radius:5px;margin-top:10px;">
                       <h4 style="font-weight:400"> Old Password:-</h4>
                        <input type="password" name="opass" class="form-control" required="required" style=" color:black;" placeholder="Old Password"/><br>
                     <h4 style="font-weight:400"> New Passwordd:-</h4>
                        <input type="password" name="npass" class="form-control" required="required" style=" color:black;" placeholder="New Password"/><br>
                        <h4 style="font-weight:400"> Confirm Password:-</h4>
                        <input type="password" name="cpass" class="form-control" required="required" style=" color:black;" placeholder="Confirm Password"/>
                        <br><br>
                        <button type="submit" class="btn btn-success" style="margin-bottom:20px;"> Change Password</button>
                        </div>
                        </form>
                    <div class="col-md-3"></div>
               </div>
