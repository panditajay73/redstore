    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
				<center><h3 style="font-size:20px;font-weight:bold">Contact Management</h3></center>
               <div class="col-md-12">
				...
				$i=0;
					...
					$i++;
						echo "<tr style='font-weight:500'>
						 ...
						 <td>".$row["msg"]."</td>
						 <td>".$row["cdt"]."</td>
						 <td><a href='../../codes/contact_delete.php?x=".$row["mobile"]."'><span class='fa fa-trash' style='font-size:20px;color:red'></span></a></td>
						</tr>";
					}
			   }
			   else
