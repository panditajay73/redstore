    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- .row -->
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12" style="cursor:pointer">
					<a href="membermgmt.php">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class="counter text-success">101</span></li>
                            </ul>
                        </div></a>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
					<a href="contactmgmt.php">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple">111</span></li>
                            </ul>
                        </div></a>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
					<a href="reviewmgmt.php">
                        <div class="white-box analytics-info">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
					<a href="addtshirts.php">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Add T-Shirts</h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id="sparklinedash2"></div>
                                </li>
                                <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple">222</span></li>
                            </ul>
                        </div></a>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
					<a href="addshoes.php">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Add Shoes</h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id="sparklinedash3"></div>
                                </li>
                                <li class="text-right"><i class="ti-arrow-up text-info"></i> <span class="counter text-info">333</span></li>
                            </ul>
                        </div></a>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
					<a href="addgadgets.php">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Add Gadgets</h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id="sparklinedash"></div>
                                </li>
                                <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class="counter text-success">100</span></li>
                            </ul>
                        </div></a>
                    </div>
                </div>
                ...
                <div class="row">
					...
					<a href="changepassword.php">
                        <div class="white-box analytics-info" style="text-align:center;">
					...
					<a href="logout.php">
                        <div class="white-box analytics-info" style="text-align:center;">
                            <h3 class="box-title" style="font-size:20px">Logout</h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id="sparklinedash2"></div>
                                </li>
                     ...
                     <div class="col-lg-4 col-sm-6 col-xs-12">
                        ...
                        <div class="white-box analytics-info" style="text-align:center;height:112px ">
                            <a href="https://mtechnologies.org/">
                            <h3 class="box-title">Mecatredz Technology</h3></a>
                            <a href="http://www.mmitsidd.com/Web/about">
                                <h3 class="box-title">M.M.I.T Siddharth Nagar</h3></a>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id="sparklinedash2"></div>
                                </li>
