    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
				<center><h3 style="font-size:20px;font-weight:bold">Gadgets Management</h3></center>
               <div class="col-md-12">
				...
				$i=0;
					...
					$i++;
						echo "<tr style='font-weight:500'>
						 <td>$i.</td>
						 <td><img src='../../gadgets/".$row["gpic"]."' style='height:50px;width:50px;border:1px solid black; border-radius:50px;'/></td>
						 <td>".$row["gcat"]."</td>
						 <td>".$row["gdt"]."</td>
						 <td><a href='../../codes/gadgets_delete.php?x=".$row["gcat"]."'><span class='fa fa-trash' style='font-size:20px;color:red'></span></a></td>
						</tr>";
					}
			   }
			   else
