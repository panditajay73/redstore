        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                  ...
                  <div class="col-md-4"><a href="shoesmgmt.php" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Shoes mgmt</a></div>
               	...
               	<div class="row">
				<center><h3 style="font-size:20px;font-weight:bold">Review Management</h3></center>
               <div class="col-md-12">
				...
				$i=0;
					...
					$i++;
						echo "<tr style='font-weight:500'>
						 ...
						 <td>".$row["comments"]."</td>
						 <td>".$row["rdt"]."</td>
						 <td><a href='../../codes/review_delete.php?x=".$row["rstar"]."'><span class='fa fa-trash' style='font-size:20px;color:red'></span></a></td>
						</tr>";
					}
			   }
			   else
