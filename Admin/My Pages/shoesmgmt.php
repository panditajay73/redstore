    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <div class="row">
				<center><h3 style="font-size:20px;font-weight:bold">Shoes Management</h3></center>
               <div class="col-md-12">
				...
				$i=0;
					...
					$i++;
						echo "<tr style='font-weight:500'>
						 <td>$i.</td>
						 <td>".$row["sname"]."</td>
						 <td><img src='../../shoes/".$row["spic"]."' style='height:50px;width:50px;border:1px solid black; border-radius:50px;'/></td>
						 <td>".$row["scat"]."</td>
						 <td>".$row["sdt"]."</td>
						 <td><a href='../../codes/shoes_delete.php?x=".$row["scat"]."'><span class='fa fa-trash' style='font-size:20px;color:red'></span></a></td>
						</tr>";
					}
			   }
			   else
