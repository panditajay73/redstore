    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
              ...
              <div class="row">
				<center><h3 style="font-size:20px;font-weight:bold">T-Shirts Management</h3></center>
               <div class="col-md-12">
						 <table class="table table-responsive" style="padding:20px;background:#fff;">
			   <tr style="font-weight:bold">
			   <th>Sr.no</th>
			   <th>Name</th>
			   <th>T-Shirt's Size No.</th>
			   <th>Picture</th>
			   <th>Type</th>
			   <th>Delete</th>
			   </tr>
				...
				$i=0;
					...
					$i++;
						echo "<tr style='font-weight:500'>
						 <td>$i.</td>
						 <td>".$row["tname"]."</td>
						 <td><img src='../../tshirts/".$row["tpic"]."' style='height:50px;width:50px;border:1px solid black; border-radius:50px; box-shadow: 0 0 20px 0px rgba(0,0,0,0.5)'/></td>
						 <td>".$row["ttype"]."</td>
						 <td><a href='../../codes/tshirts_delete.php?x=".$row["tname"]."'><span class='fa fa-trash' style='font-size:20px;color:red'></span></a></td>
						</tr>";
					}
			   }
			   else
