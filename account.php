...
<head>
    ...
    <title>Become a member - RedStore</title>
        ...
        <div class="container">
            ...
            <div class="col-2">
                ...
                <div class="form-container">
                    ...
                    <form id="LoginForm" action="codes/logincode.php" method="post">
                    <input type="emai" placeholder="Username" required name="userid">
                        <input type="password" placeholder="Password" required name="pass">
                        <button type="submit" class="btn">Login</button>
                        <a href="">Forgot Password</a>
                    </form>
                    <form id="RegForm" action="codes/membercode.php" method="post">
                    <input type="text" placeholder="Username" name="name">
                        <input type="text" placeholder="Phone Number" maxlength="10" name="mobile">
                        <input type="email" placeholder="E-mail" name="email">
                        <input type="text" placeholder="Address.." name="msg">
